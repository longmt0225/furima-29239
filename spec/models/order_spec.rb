...
RSpec.describe OrderAddress, type: :model do
  describe '商品購入機能' do
    ...
    it '郵便番号は3桁-4桁の形では登録できないこと' do
      ...
      @order_address.valid?
      expect(@order_address.errors.full_messages).to include('郵便番号が無効です。正確に入力してください')
    end
    ...
    it '電話番号にはハイフンは不要で11桁以内であること' do
      ...
      @order_address.valid?
      expect(@order_address.errors.full_messages).to include('電話番号が無効です。半角数字で正確に入力してください')
    end
